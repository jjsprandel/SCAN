...
#define EXAMPLE_PIN_NUM_SCLK 7    // 10
#define EXAMPLE_PIN_NUM_MOSI 6    // 7
#define EXAMPLE_PIN_NUM_LCD_DC 12  // 18
#define EXAMPLE_PIN_NUM_LCD_RST 10 // 11 // Will need to change this to a different pin
#define EXAMPLE_PIN_NUM_LCD_CS 11  // 15
