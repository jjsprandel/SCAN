...
#define EXAMPLE_PIN_NUM_SCLK 12    // 7
#define EXAMPLE_PIN_NUM_MOSI 13    // 6
#define EXAMPLE_PIN_NUM_LCD_DC 15  // 12
#define EXAMPLE_PIN_NUM_LCD_RST 21 // 10
#define EXAMPLE_PIN_NUM_LCD_CS 18  // 11
