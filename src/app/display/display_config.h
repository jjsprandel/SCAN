...
#define EXAMPLE_PIN_NUM_SCLK 12    // 10
#define EXAMPLE_PIN_NUM_MOSI 13    // 7
#define EXAMPLE_PIN_NUM_LCD_DC 15  // 18
#define EXAMPLE_PIN_NUM_LCD_RST 21 // 11 // Will need to change this to a different pin
#define EXAMPLE_PIN_NUM_LCD_CS 18  // 15
